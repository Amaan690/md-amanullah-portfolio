...
export function HeroSection() {
  return <section className="hero section" id="top">
    ...
    <div className="hero-copy">
      ...
      <div className="social-links"><a href={profile.github || "#contact"} target={profile.github ? "_blank" : undefined} rel="noreferrer" aria-label="GitHub"><Code2 size={18} /></a><a href={profile.linkedin || "#contact"} target={profile.linkedin ? "_blank" : undefined} rel="noreferrer" aria-label="LinkedIn"><UsersRound size={18} /></a><span className="availability"><i /> Open to meaningful problems</span></div>
    </div>
